    ...
    <nav className="sticky top-0 z-50 w-full bg-white border-b px-4 md:px-8 h-16 md:h-20 flex items-center gap-4 md:gap-8 shadow-sm">
      <div className="flex items-center gap-4 md:gap-6 shrink-0">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          {/* Main Logo increased visibility */}
      ...
      <div className="hidden lg:flex items-center bg-gray-100 p-1 shrink-0 ml-4">
        <button
          ...
          className={cn(
            "px-8 py-2.5 text-[14px] font-black uppercase tracking-widest transition-all",
      ...
      <div className="hidden xl:flex items-center gap-3 px-5 py-2.5 hover:bg-gray-50 cursor-pointer shrink-0 border border-transparent hover:border-gray-100 transition-all">
      ...
      <div className="flex-grow relative max-w-2xl group mx-4">
        ...
        <Input 
          className="w-full bg-gray-100 border-none h-11 md:h-13 pl-12 md:pl-14 text-sm md:text-base font-bold placeholder:font-medium focus-visible:ring-2 focus-visible:ring-primary/20 transition-all"
          placeholder="Search..."
        />
      </div>
      ...
      <div className="flex items-center gap-4 md:gap-6 shrink-0">
        <InstallAppButton />
        <Button variant="ghost" size="icon" className="relative bg-black text-white hover:bg-black/90 h-11 w-11 md:h-14 md:w-14 shadow-xl shadow-black/10 transition-transform active:scale-95">
          <ShoppingCart className="w-5 h-5 md:w-6 md:h-6" />
          <span className="absolute -top-1 -right-1 bg-primary text-white text-[10px] md:text-xs w-5 h-5 md:w-6 md:h-6 flex items-center justify-center font-black border-2 border-white">
            0
          </span>
        </Button>
      </div>
