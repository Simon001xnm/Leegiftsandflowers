...
export function Footer() {
  return (
    <footer className="bg-white/90 backdrop-blur-xl text-black py-12 md:py-20 border-t border-gray-100">
      <div className="max-w-[1400px] mx-auto px-5">
        <div className="grid md:grid-cols-12 gap-10 items-start md:items-center">
          
          {/* Left: Operational Information Stack */}
          <div className="md:col-span-5 flex flex-col space-y-4">
               <div className="text-[16px] md:text-[18px] text-black font-bold space-y-2">
                  <p className="uppercase tracking-tighter">Nairobi West, Nairobi, Kenya</p>
                  <p className="text-black/60 font-medium">P. O Box 7144- 00200</p>
                  <div className="pt-2 flex flex-col space-y-1">
                    <p className="text-primary font-black text-xl">0722522346</p>
                    <p className="text-black/80 font-black lowercase break-all tracking-tight">Info@steakwestbutchery.co.ke</p>
                  </div>
               </div>
          </div>
        ...
        <div className="mt-12 md:mt-16 pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="flex flex-col md:flex-row items-center gap-6 md:gap-12">
            <div className="flex flex-col md:flex-row items-center gap-4 md:gap-8 text-[10px] md:text-[11px] text-black/40 font-black uppercase tracking-[0.2em] text-center md:text-left">
          ...
          <div className="flex gap-6 md:gap-8 text-[10px] md:text-[11px] text-black/40 font-black uppercase tracking-[0.2em]">
