    ...
    <footer className="bg-black text-white border-t border-white/5 py-20">
      <div className="container mx-auto px-6">
        <div className="grid md:grid-cols-12 gap-12 items-center">
          ...
          {/* Left: Operational & Contact Info */}
          <div className="md:col-span-4 grid gap-10 text-[13px] font-bold uppercase tracking-widest">
          ...
          {/* Middle: Dispatch Partners Column */}
          ...
          {/* Right: Brand Identity (Logo Enlarged) */}
          <div className="md:col-span-5 flex justify-end">
            <div className="relative h-32 w-full max-w-[450px]">
              <Image 
