...
const STATIC_PRODUCTS = [
  ...
  { id: 'fw-serving-tray', name: "Gourmet Serving Tray", price: 2100, category: "Fine Wood Kitchen", image: "/gourmentserving.jpg", description: "Large wood serving tray for elite hospitality dispatch." },
