...
import { Clock, Store, TrendingUp, ArrowLeft, RefreshCw } from "lucide-react";
...
export default function ProductDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const handleAdd = () => {
    addToCart({
      id: product.id,
      restaurantId: product.restaurant_id || 'r1',
      name: product.name,
      price: product.price,
      description: product.description || '',
      imageUrl: product.image_url || `https://picsum.photos/seed/${product.id}/600/600`,
            ...
            <div className="lg:col-span-5 space-y-8">
              ...
              <div className="space-y-6">
                <p className="text-[14px] font-medium text-gray-600 leading-relaxed">
                  {product.description || "Premium quality product from the Steak West network."}
                </p>
