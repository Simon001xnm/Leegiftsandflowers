  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-grow">
        <div className="relative h-[400px] md:h-[600px] bg-black overflow-hidden flex items-center">
          ...
          <div className="relative z-20 px-8 container mx-auto text-white space-y-8">
            ...
            <div className="flex flex-wrap gap-4 items-center">
              <Link href="/restaurants">
                <button className="h-12 px-10 bg-primary font-black text-[11px] uppercase tracking-[0.1em] rounded-full hover:scale-105 transition-transform active:scale-95 shadow-xl">
                  SHOP THE MARKET
                </button>
              </Link>
              <InstallAppButton />
          ...
          <Image src="https://picsum.photos/seed/steak9/1200/800" alt="Hero" fill className="object-cover opacity-60" priority />
        </div>
