...
import { Calendar, MapPin, ArrowRight, Sparkles, CheckCircle2, LayoutDashboard, Flower2, Heart } from "lucide-react";
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-3xl">
              ...
              <p className="text-xl text-muted-foreground mb-12 max-w-xl leading-relaxed">
                Lee Decors and Flowers brings your most precious visions to life with world-class floral designs and luxury event transformations.
              </p>
        ...
        <section className="py-24 container mx-auto px-4">
          <div className="flex items-end justify-between mb-16">
            <div>
              <h2 className="text-4xl font-bold font-headline text-primary mb-3">Our Latest Showcases</h2>
        ...
        {/* Brand Philosophy */}
        <section className="py-28 bg-primary text-primary-foreground overflow-hidden rounded-[3rem] mx-4 lg:mx-8">
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row justify-between items-center gap-12">
            ...
            <div className="flex flex-wrap justify-center gap-10 text-sm font-bold text-primary/70">
              ...
              <Link href="#" className="hover:text-accent transition-colors uppercase tracking-widest">Privacy</Link>
            </div>
