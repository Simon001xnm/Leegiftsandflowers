        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="col-span-full bg-red-600 rounded-[2.5rem] overflow-hidden flex flex-col md:flex-row items-center p-8 md:p-12 text-white shadow-2xl relative">
            <div className="absolute top-6 right-8 bg-white/20 backdrop-blur-md px-4 py-1.5 rounded-full flex items-center gap-2">
              ...
              <span className="text-xs font-bold">Ends in 4h 20m</span>
            </div>
            <div className="space-y-6 flex-grow">
              <div className="space-y-2">
                <p className="text-sm font-bold uppercase tracking-widest opacity-80">Flash sale</p>
                <h2 className="text-4xl md:text-6xl font-bold leading-none">Weekend BBQ pack</h2>
                <p className="text-xl opacity-90">2kg Beef + 2kg Chicken + Free Marinade</p>
              </div>
              <div className="flex items-center gap-6">
                <div>
                  <p className="text-xs opacity-60 uppercase font-bold">Now only</p>
                  <p className="text-4xl font-black">KSh 2,499</p>
                </div>
                <div className="h-12 w-px bg-white/20" />
                <div>
                  <p className="text-xs opacity-60 uppercase font-bold">Save</p>
    ...
    <div className={cn("p-10 rounded-[2.5rem] space-y-6 relative overflow-hidden", bg)}>
      ...
      <div className={cn("border-t pt-6 flex items-center justify-between", light ? "border-black/5" : "border-white/10")}>
        <div className="space-y-1">
          ...
          <p className={cn("font-mono font-bold text-lg", light ? "text-black" : "text-white")}>{code}</p>
        </div>
