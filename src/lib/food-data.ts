...
export const MOCK_RESTAURANTS: Restaurant[] = [
  {
    ...
    description: 'Nairobi\'s finest selection of premium beef and pork. Fresh from the farm.',
...
export const MOCK_MENU: MenuItem[] = [
  ...
  { id: 'c-ulimi-cow', restaurantId: 'r1', name: 'Full Ulimi Cow', price: 1400, description: 'Prime cow tongue, cooked to tender perfection.', imageUrl: '/images (46).jpg', category: 'Cooked' },
  ...
  { id: 'g2', restaurantId: 'r1', name: 'Fresh Kachumbari', price: 150, description: 'Fresh tomatoes, onions, and coriander.', imageUrl: 'https://images.unsplash.com/photo-1510627498534-cf7e9002facc?q=80&w=600', category: 'Grocery' },
