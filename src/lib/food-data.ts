...
export const MOCK_MENU: MenuItem[] = [
  { id: 'c-goat-wet-1kg', restaurantId: 'r1', name: 'Beef Wet Fry 1kg', price: 1400, description: 'Expertly spiced beef, wet-fried to tender perfection.', imageUrl: '/images (41).jpg', category: 'Cooked' },
