...
export const MOCK_MENU: MenuItem[] = [
  { id: 'c-goat-wet-1kg', restaurantId: 'r1', name: 'Goat Wet Fry 1kg', price: 1400, description: 'Expertly spiced goat meat, wet-fried to tender perfection.', imageUrl: '/images (41).jpg', category: 'Cooked' },
